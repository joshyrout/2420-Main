...
public class ParkJourney{
    ...
    public ParkJourney(){
        vertex = -1;
        parkArray = readFile("src/TP01/NationalParks.txt", ",", ParkType.National);
    ...
    public static void main(String[] args) {
        ParkJourney parkJourney = new ParkJourney();
        Iterable<Park> parks = parkJourney.shortestPath(81, 25);
